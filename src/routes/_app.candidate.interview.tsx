  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <SectionCard title={`Question ${step + 1} of ${questions.length}`} className="lg:col-span-2">
          <div className="p-6">
            ...
            <div className="mt-6 flex justify-end gap-2">
              ...
              >
                {step + 1 >= questions.length ? "Finish" : "Next question"} <Play className="size-3" />
              </button>
            </div>
          </div>
        </SectionCard>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <PageHeader
        ...
        actions={
          <button onClick={onRestart} className="rounded-md border border-border px-3 py-2 text-xs font-semibold">
            Run another session
          </button>
        }
      />
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-xl bg-foreground p-6 text-background">
          ...
          <div className="mt-1 text-xs text-background/70">Strong performance · top 12% of sessions</div>
