...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ATS Engine — Intelligent Applicant Tracking" },
      {
        name: "description",
        content:
          "The intelligent bridge between talent and opportunity. AI-powered recruiting for employers and a full career suite for candidates.",
      },
